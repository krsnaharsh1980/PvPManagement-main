    ...
    <body>
        ...
        <nav class="navbar mnav navbar-expand-lg navbar-dark bg-dark static-top" style="border: 5px double black;border-radius:5px;">
            <div class="container" style = "font-family:'PT Serif';font-size:22px;padding-right:0px;margin-right:0%;">
                <a style = "margin-left:0%;padding-left:0px" class="navbar-brand" href="http://rvce.edu.in">
        ...
        <div class=" mcontainer">
            <form name = "register" method = "post" class = "myform" action = "" enctype="multipart/form-data">
                <h1 class = "tit">PVP Registration</h1>
                    <?php echo @$err; ?>
                ...
                <table width = "100%">
                    ...
                    <tr>  
                        ...
                        <td class = "td1">
                            <input type = "text" name = "USN" placeholder = "1RV21CS047" required/>
                        </td>
                    </tr>
                    ...
                    <tr>  
                        ...
                        <td class = "td1">
                            <input type = "email" name = "mail" placeholder = "student.cs21@rvce.edu.in" required/>
                        </td>
                    </tr>
