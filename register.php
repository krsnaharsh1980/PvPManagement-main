        ...
        <form name="register" method="post" class="myform" action="" enctype="multipart/form-data">
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td class="td1">
                        <input type="text" name="USN" autocomplete="off" placeholder="1RV21CS047" required />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="td1">
                        <input type="email" name="mail" autocomplete="off" placeholder="student.cs21@rvce.edu.in" required />
                    </td>
                </tr>
