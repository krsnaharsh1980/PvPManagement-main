...
<body>
    ...
    <div class="wrapper">
        <div class="sidebar col -l2 -s6">
            <ul>
                <div>
                    <img class="img1" src="../css/images/logo.jpeg" width="100" height="100" alt="not found" />
                </div>
                <li><a href="dashboard.php"><i class="fas fa-clipboard"></i>Dashboard</a></li>
                <li><a href="dashboard.php?page=manage_users"><i class="fas fa-users"></i>Registerd Students</a></li>
                <li><a href="dashboard.php?page=manage_users_fst"><i class="fas fa-users"></i>PvP Students</a></li>
                <li>
                    <div class="mdbtn">
                                ...
                                <div class="row" style="margin-top:3%;">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat1" href="dashboard.php?page=manage_users">
                                            ...
                                            <span class="name">Students Registered<br />For PvP</span>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat1" href="dashboard.php?page=manage_users_fst">
                                            ...
                                            <span class="name">Registrations<br />PvP</span>
                                            <span class="bg-icon"><i class="fa fa-users"></i></span>
                                        </a>
                                        <!-- /.dashboard-stat -->
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat11" href="dashboard.php?page=graph">
                                            ...
                                            <span class="name">Statistics<br />For PvP</span>
                                            <span class="bg-icon"><i class="fa fa-bars"></i></span>
                                        </a>
                                        <!-- /.dashboard-stat -->
                                    </div>
